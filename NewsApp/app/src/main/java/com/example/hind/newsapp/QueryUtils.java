...
public class QueryUtils {
    ...
    private static List<News> extractFeatureFromJson(String newsJSON) {
        ...
        try {
            ...
            JSONArray results = newsObj.getJSONArray("results");
            ...
            for (int i = 0; i < results.length(); i++) {
                ...
                String section = currentNews.optString("sectionId");
                ...
                // Create a new {@link News} object with the type, title,url, date
                // and author from the JSON response.
                News news1 = new News(section, title,url, date, author);
